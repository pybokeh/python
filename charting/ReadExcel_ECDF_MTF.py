...
ELP_2008 = df[(df['MODEL_YEAR']==2008) & (df['FACTORY_CODE']=='ELP') & (df['MODEL_NAME']=='CIVIC')]['MILES_TO_FAIL'].values
HCM_2008 = df[(df['MODEL_YEAR']==2008) & (df['FACTORY_CODE']=='HCM') & (df['MODEL_NAME']=='CIVIC')]['MILES_TO_FAIL'].values
SSS_2008 = df[(df['MODEL_YEAR']==2008) & (df['FACTORY_CODE']=='SSS') & (df['MODEL_NAME']=='CIVIC')]['MILES_TO_FAIL'].values
